    ...
    function refreshDeviceStatus() {
        ...
        fetch("http://127.0.0.1:8080/api/device-status")
            ...
            .then(data => {
                    ...
                    document.getElementById("lightBrightness").textContent = data.light.brightness + "%";
                    document.getElementById('lightSwitchCount').textContent = data.light.switchCount;
                    document.getElementById('lightUsageTime').textContent = data.light.usageTime.toFixed(2) + " giây";
                    ...
                    document.getElementById('fanUsageTime').textContent = data.fan.usageTime.toFixed(2) + " giây";
                })
